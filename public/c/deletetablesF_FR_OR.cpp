...
void _help(char *argv[])
{
  printf("\nUsing:/htidc/public/bin/deletetablesF_FR_OR \"<logfilename>/log/shqx/deletetables_SURFDATA.log</logfilename><connstr>shqx/pwdidc@snorcl11g_119</connstr><tname>T_SURFDATA</tname><where>where ddatetime<sysdate-0.7</where><hourstr>20,21,22,23,24</hourstr>\"\n\n");
