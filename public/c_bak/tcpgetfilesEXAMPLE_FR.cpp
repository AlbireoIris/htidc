...
{
  printf("\n");
  printf("Using:/htidc/public/bin/tcpgetfilesEXAMPLE_FR logfilename xmlbuffer\n\n");

  printf("Sample:/htidc/public/bin/tcpgetfilesEXAMPLE_FR /log/shqx/tcpgetfilesEXAMPLE_FR_surfdata.log \"<ip>119.29.18.109</ip><port>5010</port><ptype>1</ptype><clientpath>/data/shqx/sdata/surfdata</clientpath><srvpath>/data/shqx/tcp/surfdata</srvpath><srvpathbak>/data/shqx/tcp/surfdatabak</srvpathbak><andchild>true</andchild><matchname>SURF_*.TXT,*.DAT</matchname><okfilename>/data/shqx/tcplist/tcpgetfilesEXAMPLE_FR_surfdata.xml</okfilename><timetvl>10</timetvl>\"\n\n\n");
